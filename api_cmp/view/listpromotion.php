...
$getListPromotions->tipoRed=3;//3:FICHA RED COMERCIAL $_GET
$getListPromotions->idCategoria=$_GET["n"];
$getListPromotions->startRange=$_GET["r"];
$resultGetListPromotions=$getListPromotions->getListPromotions();
...
$urlName=cleanText($urlName);
	...
	$result[]=array("urlName"=>"promocion-".strtolower($urlName)."?n=".$row["idcp_pdf_ficha"]."_comercial&s=".utf8_encode($dataNameCategoty["nombre_categoria"])."-".strtolower($nameSocio),
	                "namesocio"=>$nameSocio,
	                "image"=>$image64,
