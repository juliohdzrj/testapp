...
$getListPromotions->tipoRed=4;//3:FICHA RED COMERCIAL $_GET
...
while($row=$resultGetListPromotions["code"]->fetch(PDO::FETCH_ASSOC)){
	...
	$result[]=array("urlName"=>"descuento-".strtolower($urlName)."?n=".$row["idcp_pdf_ficha"]."_medica&s=".utf8_encode($dataNameCategoty["nombre_categoria"])."-".strtolower($nameSocio),
	                "namesocio"=>$nameSocio,
	                "image"=>$image64,
